    ...
    try:
        ...
        with connect(**LOCAL_DB_CONFIG) as connection:
            with connection.cursor() as cursor:
                ...
                # 과목 스케줄 추가 (시간표가 겹치지 않도록 배치)
                print("과목 스케줄 데이터 삽입 중...")
                # 과목 1: 데이터베이스 (월/수/화) - 홍길동이 화요일에 수강
                ...
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (1, "TUE", "08:00:00", "09:30:00", "101호"))
                # 과목 2: 운영체제 (화/목) - 홍길동이 화요일에 수강
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (2, "TUE", "09:30:00", "11:00:00", "102호"))
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (2, "THU", "09:30:00", "11:00:00", "102호"))
                # 과목 3: 디지털회로 (월/수/화) - 홍길동이 화요일에 수강
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (3, "MON", "13:00:00", "14:30:00", "201호"))
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (3, "WED", "13:00:00", "14:30:00", "201호"))
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (3, "TUE", "11:00:00", "12:30:00", "201호"))
                # 과목 4: 네트워크프로그래밍 (화/목)
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (4, "TUE", "12:30:00", "14:00:00", "202호"))
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (4, "THU", "12:30:00", "14:00:00", "202호"))
                # 과목 5: 알고리즘 (화/목) - 홍길동이 화요일에 수강
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (5, "TUE", "14:00:00", "15:30:00", "103호"))
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (5, "THU", "14:00:00", "15:30:00", "103호"))
                # 과목 6: 컴퓨터구조 (화/목) - 홍길동이 화요일에 수강
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (6, "TUE", "15:30:00", "17:00:00", "203호"))
                cursor.execute("INSERT INTO subject_schedule (subject_id, day_of_week, start_time, end_time, location) VALUES (%s, %s, %s, %s, %s)", 
                              (6, "THU", "15:30:00", "17:00:00", "203호"))
                
                # 수강 등록 추가 - 각 학생이 5개 과목을 수강하도록 설정
                print("수강 등록 데이터 삽입 중...")
                # 각 학생별로 5개 과목 수강
                # 학생 1 (홍길동): 과목 1, 2, 3, 5, 6 (화요일에 5개 모두 수강)
                for subject_id in [1, 2, 3, 5, 6]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (1, subject_id))
                # 학생 2 (김철수): 과목 1, 2, 3, 4, 5
                for subject_id in [1, 2, 3, 4, 5]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (2, subject_id))
                # 학생 3 (이영희): 과목 1, 2, 3, 4, 6
                for subject_id in [1, 2, 3, 4, 6]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (3, subject_id))
                # 학생 4 (박민수): 과목 1, 2, 3, 5, 6
                for subject_id in [1, 2, 3, 5, 6]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (4, subject_id))
                # 학생 5 (최지영): 과목 1, 4, 5, 6 + 하나 더
                for subject_id in [1, 4, 5, 6]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (5, subject_id))
                cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (5, 2))
                # 학생 6 (정수진): 과목 2, 4, 5, 6 + 하나 더
                for subject_id in [2, 4, 5, 6]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (6, subject_id))
                cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (6, 3))
                # 학생 7 (강동현): 과목 2, 3, 4, 5, 6
                for subject_id in [2, 3, 4, 5, 6]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (7, subject_id))
                # 학생 8 (윤서연): 과목 1, 3, 4, 5, 6
                for subject_id in [1, 3, 4, 5, 6]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (8, subject_id))
                # 학생 9 (임태영): 과목 2, 3, 4, 5, 6
                for subject_id in [2, 3, 4, 5, 6]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (9, subject_id))
                # 학생 10 (한소미): 과목 1, 2, 4, 5, 6
                for subject_id in [1, 2, 4, 5, 6]:
                    cursor.execute("INSERT INTO enrollment (student_id, subject_id) VALUES (%s, %s)", (10, subject_id))
                
                # 수업 세션 추가 (2025년 2학기: 9월 1일 ~ 11월 25일까지)
                print("수업 세션 데이터 삽입 중...")
                
                semester_start = datetime(2025, 9, 1).date()
                # 11월 25일까지 생성 (테스트용)
                semester_end = datetime(2025, 11, 25).date()
                
                # 스케줄별 요일 매핑
                schedule_weekdays = {
                    1: 0,   # 과목 1: 월요일 (MON)
                    2: 2,   # 과목 1: 수요일 (WED)
                    3: 1,   # 과목 1: 화요일 (TUE) - 홍길동용
                    4: 1,   # 과목 2: 화요일 (TUE)
                    5: 3,   # 과목 2: 목요일 (THU)
                    6: 0,   # 과목 3: 월요일 (MON)
                    7: 2,   # 과목 3: 수요일 (WED)
                    8: 1,   # 과목 3: 화요일 (TUE) - 홍길동용
                    9: 1,   # 과목 4: 화요일 (TUE)
                    10: 3,  # 과목 4: 목요일 (THU)
                    11: 1,  # 과목 5: 화요일 (TUE)
                    12: 3,  # 과목 5: 목요일 (THU)
                ...
                all_sessions = []  # (session_id, schedule_id, class_date, is_cancelled) 튜플 리스트
                
                # 각 스케줄에 대해 9월 1일부터 11월 24일까지의 모든 수업 날짜 생성
                for schedule_id in range(1, 15):
                ...
                # 출석 정보 추가 (11월 24일까지의 모든 수업 + 11월 25일 13시 30분까지의 수업)
                print("출석 데이터 삽입 중...")
                
                # 수강생 정보: 각 과목별 수강생 리스트
                enrolled_students = {
                    1: [1, 2, 3, 4, 5, 8, 10],      # 과목 1: 학생 1, 2, 3, 4, 5, 8, 10
                    2: [1, 2, 3, 4, 5, 6, 7, 9, 10], # 과목 2: 학생 1, 2, 3, 4, 5, 6, 7, 9, 10
                    3: [1, 2, 3, 4, 6, 7, 8, 9],    # 과목 3: 학생 1, 2, 3, 4, 6, 7, 8, 9
                    4: [2, 3, 5, 6, 7, 8, 9, 10],    # 과목 4: 학생 2, 3, 5, 6, 7, 8, 9, 10
                    5: [1, 2, 4, 5, 6, 7, 8, 9, 10], # 과목 5: 학생 1, 2, 4, 5, 6, 7, 8, 9, 10
                    6: [1, 3, 4, 5, 6, 7, 8, 9, 10], # 과목 6: 학생 1, 3, 4, 5, 6, 7, 8, 9, 10
                }
                
                # 스케줄 ID -> 과목 ID 매핑
                schedule_to_subject = {
                    1: 1, 2: 1, 3: 1,   # 과목 1 (월/수/화)
                    4: 2, 5: 2,         # 과목 2 (화/목)
                    6: 3, 7: 3, 8: 3,  # 과목 3 (월/수/화)
                    9: 4, 10: 4,       # 과목 4 (화/목)
                    11: 5, 12: 5,      # 과목 5 (화/목)
                    13: 6, 14: 6,      # 과목 6 (화/목)
                }
                ...
                # 11월 25일 13시 30분까지의 수업 스케줄 ID (화요일 수업 중 13:30 이전 종료)
                # schedule_id 3: 과목 1 화요일 08:00-09:30
                # schedule_id 4: 과목 2 화요일 09:30-11:00
                # schedule_id 8: 과목 3 화요일 11:00-12:30
                nov_25_schedules = [3, 4, 8]  # 11월 25일 13:30까지의 수업
                nov_25_date = datetime(2025, 11, 25).date()
                
                # 각 세션에 대해 출석 데이터 생성
                for session_id, schedule_id, class_date, is_cancelled in all_sessions:
                    # 11월 25일 13시 30분까지의 수업은 나중에 별도로 처리하므로 건너뛰기
                    if class_date == nov_25_date and schedule_id in nov_25_schedules:
                        continue
                    
                    # 11월 25일 화요일 수업 중 13:30 이후 종료되는 수업은 출석 데이터 생성하지 않음
                    # schedule_id 9: 12:30-14:00, schedule_id 11: 14:00-15:30, schedule_id 13: 15:30-17:00
                    if class_date == nov_25_date and class_date.weekday() == 1:  # 화요일
                        if schedule_id in [9, 11, 13]:  # 13:30 이후 종료되는 수업
                            continue
                    ...
                    if is_cancelled:
                        ...
                        if subject_id == 1:  # 데이터베이스 (월/수) - 100% 출석률
                        ...
                        elif subject_id == 3:  # 디지털회로 (월/수) - 70~80% 출석률
                            for idx, student_id in enumerate(students):
                                status = "PRESENT"
                                
                                # 월요일 패턴 - 70~80% 출석률을 위해 일부 결석 추가
                                if day_of_week == 0:  # 월요일
                                    if week_number == 1 and idx == 1:
                                        status = "LATE"
                                    elif week_number == 2 and idx == len(students) - 1:
                                        status = "ABSENT"
                                    elif week_number == 3 and idx == 0:
                                        status = "ABSENT"
                                    elif week_number == 4 and idx == len(students) // 2:
                                        status = "ABSENT"
                                    elif week_number == 5 and (idx == 2 or idx == len(students) - 2):
                                        status = "LATE"
                                    elif week_number == 6 and idx == len(students) - 1:
                                        status = "ABSENT"
                                    elif week_number == 7 and idx == 1:
                                        status = "LATE"
                                    elif week_number == 8 and idx == 0:
                                        status = "ABSENT"
                                    elif week_number == 9 and (idx == len(students) // 2 or idx == len(students) - 1):
                                        status = "LATE"
                                    elif week_number == 10 and idx == 2:
                                        status = "ABSENT"
                                    elif week_number == 11 and idx == 0:
                                        status = "LATE"
                                ...
                                # 수요일 패턴 (다른 패턴)
                                    ...
                                    if week_number == 1 and idx == 0:
                                        ...
                                        status = "ABSENT"
                                    elif week_number == 10 and (idx == 2 or idx == len(students) - 2):
                                        status = "LATE"
                                    elif week_number == 11 and idx == len(students) - 1:
                                        status = "ABSENT"
                                    elif week_number == 12 and idx == 0:
                                        status = "LATE"
                        ...
                        elif subject_id == 5:  # 알고리즘 (화/목) - 80~85% 출석률
                            for idx, student_id in enumerate(students):
                                status = "PRESENT"
                                
                                # 화요일 패턴 - 80~85% 출석률을 위해 일부 결석 추가
                                if day_of_week == 1:  # 화요일
                                    if week_number == 3 and idx == len(students) - 1:
                                        status = "ABSENT"
                                    elif week_number == 5 and idx == 0:
                                        status = "LATE"
                                    elif week_number == 7 and idx == len(students) // 2:
                                        status = "ABSENT"
                                    elif week_number == 9 and idx == len(students) - 2:
                                        status = "LATE"
                                    elif week_number == 11 and idx == 1:
                                        status = "ABSENT"
                                # 목요일 패턴
                                elif day_of_week == 3:  # 목요일
                                    if week_number == 2 and idx == 2:
                                        status = "ABSENT"
                                    elif week_number == 4 and idx == len(students) - 1:
                                        status = "LATE"
                                    elif week_number == 6 and idx == 0:
                                        status = "ABSENT"
                                    elif week_number == 8 and idx == len(students) // 2:
                                        status = "LATE"
                                    elif week_number == 10 and idx == len(students) - 1:
                                        status = "ABSENT"
                                    elif week_number == 12 and idx == 1:
                        ...
                        elif subject_id == 6:  # 컴퓨터구조 (화/목) - 60~70% 출석률 (저조)
                            for idx, student_id in enumerate(students):
                                status = "PRESENT"
                                
                                # 화요일 패턴 - 60~70% 출석률을 위해 더 많은 결석 추가
                                if day_of_week == 1:  # 화요일
                                    if week_number == 1 and (idx == len(students) - 1 or idx == 0 or idx == 1):
                                        status = "ABSENT"
                                    elif week_number == 2 and idx == len(students) // 2:
                                        status = "LATE"
                                    elif week_number == 3 and (idx == 1 or idx == len(students) - 2):
                                        status = "ABSENT"
                                    elif week_number == 4 and (idx == len(students) - 2 or idx == 0):
                                        status = "ABSENT"
                                    elif week_number == 5 and idx == len(students) - 1:
                                        status = "LATE"
                                    elif week_number == 6 and (idx == 2 or idx == len(students) // 2):
                                        status = "ABSENT"
                                    elif week_number == 7 and idx == len(students) - 1:
                                        status = "ABSENT"
                                    elif week_number == 8 and idx == 1:
                                        status = "LATE"
                                    elif week_number == 9 and (idx == len(students) - 1 or idx == 0):
                                        status = "ABSENT"
                                    elif week_number == 10 and idx == 2:
                                        status = "ABSENT"
                                    elif week_number == 11 and idx == len(students) - 2:
                                        status = "LATE"
                                    elif week_number == 12 and (idx == 2 or idx == len(students) - 1):
                                        status = "ABSENT"
                                # 목요일 패턴
                                elif day_of_week == 3:  # 목요일
                                    if week_number == 1 and (idx == len(students) - 1 or idx == 0):
                                        status = "ABSENT"
                                    elif week_number == 2 and idx == 1:
                                        status = "LATE"
                                    elif week_number == 3 and (idx == 1 or idx == len(students) - 2 or idx == 0):
                                        status = "ABSENT"
                                    elif week_number == 4 and idx == len(students) // 2:
                                        status = "ABSENT"
                                    elif week_number == 5 and idx == 0:
                                        status = "LATE"
                                    elif week_number == 6 and (idx == len(students) - 1 or idx == 2):
                                        status = "ABSENT"
                                    elif week_number == 7 and idx == 1:
                                        status = "LATE"
                                    elif week_number == 8 and (idx == len(students) - 2 or idx == 0):
                                        status = "ABSENT"
                                    elif week_number == 9 and idx == len(students) - 1:
                                        status = "ABSENT"
                                    elif week_number == 10 and idx == len(students) // 2:
                                        status = "LATE"
                                    elif week_number == 11 and (idx == len(students) - 1 or idx == 1):
                                        status = "ABSENT"
                                    elif week_number == 12 and idx == 0:
                                        status = "ABSENT"
                ...
                # 11월 25일 13시 30분까지의 수업에 대한 출석 데이터 추가 (수동으로 일일이 집어넣기)
                print("11월 25일 13시 30분까지의 출석 데이터 삽입 중...")
                nov_25_checkin_count = 0
                
                # 11월 25일의 해당 스케줄 세션 조회
                for schedule_id in nov_25_schedules:
                    cursor.execute("""
                        SELECT session_id FROM class_session
                        WHERE schedule_id = %s AND class_date = %s
                    """, (schedule_id, nov_25_date))
                    ...
                    # 각 학생별로 수동으로 출석 데이터 삽입
                    if schedule_id == 3:  # 과목 1 (데이터베이스) 화요일 08:00-09:30
                        # 학생별 개별 출석 데이터 삽입
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 1, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 2, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 3, "LATE", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 4, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 5, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 8, "ABSENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 10, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        nov_25_checkin_count += 7
                        checkin_count += 7
                    elif schedule_id == 4:  # 과목 2 (운영체제) 화요일 09:30-11:00
                        # 학생별 개별 출석 데이터 삽입
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 1, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 2, "LATE", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 3, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 4, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 5, "ABSENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 6, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 7, "LATE", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 9, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 10, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        nov_25_checkin_count += 9
                        checkin_count += 9
                    elif schedule_id == 8:  # 과목 3 (디지털회로) 화요일 11:00-12:30
                        # 학생별 개별 출석 데이터 삽입
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 1, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                        ...
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 3, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 4, "LATE", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 6, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 7, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 8, "ABSENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        cursor.execute("INSERT INTO checkin (session_id, student_id, status, check_time) VALUES (%s, %s, %s, %s)", 
                                      (session_id, 9, "PRESENT", datetime(2025, 11, 25, 13, 30).strftime('%Y-%m-%d %H:%M:%S')))
                        nov_25_checkin_count += 8
                        checkin_count += 8
                
                print(f"11월 25일 출석 데이터 {nov_25_checkin_count}개 추가 완료")
